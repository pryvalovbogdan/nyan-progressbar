...
export function ReleaseReviewCard({ review, version }: IReleaseReviewCardProps) {
  return (
    <article className="relative flex h-full flex-col gap-3 rounded-2xl border border-border bg-card p-4 transition-all duration-300 hover:-translate-y-1 hover:border-[#80deea]/40 hover:shadow-[0_8px_24px_rgba(128,222,234,0.18)]">
      <div
        aria-hidden="true"
